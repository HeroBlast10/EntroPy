...
from quant_platform.core.portfolio.construction import PortfolioConfig, PortfolioMode
...
def apply_constraints(
    ...
    """
    from quant_platform.core.portfolio.construction import PortfolioConstructor
