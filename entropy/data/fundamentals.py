...
from entropy.data.calendar import align_to_calendar, next_trading_day, trading_dates
from entropy.data.schema import FUNDAMENTALS_SCHEMA, validate_dataframe
...
def build_fundamentals(
    ...
    # --- Resolve tickers ---
    if tickers is None:
        from entropy.data.prices import get_ticker_list
