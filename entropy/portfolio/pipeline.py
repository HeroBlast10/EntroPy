...
from entropy.portfolio.construction import PortfolioConfig, PortfolioConstructor, PortfolioMode
from entropy.portfolio.quantile import QuantilePortfolio
from entropy.portfolio.optimize import OptimizedPortfolio
...
def run_portfolio_pipeline(
    ...
    **constructor_kwargs : extra kwargs passed to the constructor
    ...
    from entropy.data.calendar import trading_dates as get_trading_dates
