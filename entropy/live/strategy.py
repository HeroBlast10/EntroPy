...
from entropy.live.config import PaperTradingConfig
from entropy.live.execution import OrderManager
from entropy.live.gateway import IBGateway
from entropy.live.market_data import MarketDataManager
from entropy.live.portfolio import PortfolioTracker
from entropy.live.risk import RiskManager
...
class PaperTradingStrategy:
    ...
    def _load_factor_weights(self, prices: Dict[str, float]) -> Optional[Dict[str, float]]:
        ...
        try:
            from entropy.utils.io import resolve_data_path, load_parquet
